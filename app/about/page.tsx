      ...
      <section className="about-section">
        <div className="container">
          ...
          <div className="content">
            ...
            <p>
              The Centre also serves as the supervisory body of the <a href="https://www.manowarng.org" target="_blank">Man O’ War</a> Voluntary Organization, providing policy direction, institutional oversight and support for one of Nigeria’s foremost volunteer and citizenship development organizations.
            </p>
            <p>
          ...
          <div className="content">
            <p>
              ...
              To establish, supervise and strengthen the <a href="https://www.manowarng.org" target="_blank">Man O’ War</a> Voluntary Organization in promoting volunteerism, civic responsibility and community service. <br />
        ...
        <div className="container">
          ...
          <div className="team-grid">
            ...
            <div className="leader-card">
              <img className="leader-img" src="/6.jpeg" alt="Mrs. Ada Veronica Uche" />
              <div className="leader-info">
            ...
            <div className="leader-card">
              <img className="leader-img" src="/3.jpeg" alt="Mr Adiole Marshall" />
              <div className="leader-info">
            ...
            <div className="leader-card">
              <img className="leader-img" src="/1.jpeg" alt="Dr. Abokwara-Adjekota Alero" />
              <div className="leader-info">
             ...
             <div className="leader-card">
              <img className="leader-img" src="/2.jpeg" alt="Mr. Ebiwari Elehibiri" />
              <div className="leader-info">
            ...
            <div className="leader-card">
              <img className="leader-img" src="/4.jpeg" alt="Alhaji Usman Furfuri" />
              <div className="leader-info">
