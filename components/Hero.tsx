    ...
    <section className="hero">
      <div className="hero-container">
        ...
        <div className="hero-right">
          <h1 className="hero-title">Citizenship & Leadership Training Centre</h1>
          ...
          <div className="hero-description">
            ...
            <p>
              It is principally a human resource development outfit established for the training and moulding of Nigeria Citizenry to become responsible and respectable Citizens and Leaders.
            </p>
            <p>
